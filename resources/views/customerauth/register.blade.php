                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('customerregister') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" name="mobile" class="form-control form-control-user" id="mobile"
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="{{url('customerforgot-password')}}">Forgot Password?</a>
                            </div>
                            <div class="text-center">
                                <a class="small" href="{{ route('customerlogin') }}">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
