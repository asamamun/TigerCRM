                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        <div class="nav-item dropdown dropright">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Computer<i class="fa fa-angle-right float-right mt-1"></i></a>
                        ...
                        <a href="" class="nav-item nav-link">Security</a>
                        <a href="" class="nav-item nav-link">Office Equipmen</a>
                        <a href="" class="nav-item nav-link">Camera</a>
                        <a href="" class="nav-item nav-link">Component</a>
                        <a href="" class="nav-item nav-link">Gadget</a>
